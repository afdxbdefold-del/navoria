...
export const SYMPTOMS = [
...

  {
    ...
    faqs: [
      { q: 'Was tun bei Zahnschmerzen am Wochenende?', a: 'Der zahnärztliche Notdienst ist in Deutschland auch an Wochenenden und Feiertagen erreichbar. Die aktuelle Notdienst-Praxis und -Apotheke finden Sie über die Website Ihrer Landeszahnärztekammer oder telefonisch bei deren Rufbereitschaft. Zur Überbrückung können bei Bedarf rezeptfreie Schmerzmittel und Kühlung helfen – Auswahl und Dosierung nach Packungsbeilage und ggf. nach Rücksprache mit Apotheke oder Ärztin/Arzt; Gegenanzeigen (etwa Magen-Darm-Erkrankungen, eingeschränkte Nierenfunktion, Blutverdünner, Schwangerschaft) beachten. Für Kinder gelten andere Empfehlungen.' },
