...
export function buildFaqs(d, { humanizedType, hasHours } = {}) {
  ...
  // 6. Website – FAQ nur wenn eine Website hinterlegt ist. Ohne Website macht
  // die Frage keinen Sinn (führte zum Text "Eine offizielle Website ist uns nicht bekannt",
  // der weder für Nutzer noch für Google Mehrwert bietet).
  if (d.website_url) {
    items.push({
