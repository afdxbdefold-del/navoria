...
export async function importOneQuery({ city, query, placeType, maxResults = 60 }) {
  ...
  let pageToken = null;
  let totalFound = 0, inserted = 0, updated = 0, skipped = 0, skippedDiscarded = 0, errors = 0;
  const errorMessages = [];
  ...
  return { found: totalFound, inserted, updated, skipped, skipped_discarded: skippedDiscarded, errors, errorMessages };
}
