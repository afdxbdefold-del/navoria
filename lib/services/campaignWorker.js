...
export async function createCampaign({ cities, specialtySlugs, maxPerQuery = 60 }) {
  ...
  const campaign = {
    ...
    done_queries: 0,
    found: 0, inserted: 0, updated: 0, skipped: 0, skipped_discarded: 0, errors: 0,
    current_query: null,
    status: 'running',
  ...
  const saveProgress = async (extra = {}) => {
    await col.updateOne({ id: campaignId }, {
      $set: {
        ...
        skipped: stats.skipped, skipped_discarded: stats.skipped_discarded, errors: stats.errors,
